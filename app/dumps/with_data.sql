...
-- ----------------------------
BEGIN;
INSERT INTO "public"."collections" VALUES (0, 'Russian trains', 0, 0, 1);
INSERT INTO "public"."collections" VALUES (1, 'American plains', 1, 1, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."colors" VALUES (0, 'black');
INSERT INTO "public"."colors" VALUES (1, 'white');
INSERT INTO "public"."colors" VALUES (2, 'red');
INSERT INTO "public"."colors" VALUES (3, 'green');
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."countries" VALUES (0, 'Russia');
INSERT INTO "public"."countries" VALUES (1, 'USA');
INSERT INTO "public"."countries" VALUES (2, 'USSR');
INSERT INTO "public"."countries" VALUES (3, 'Japan');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."locations" VALUES (0, 0, 1, 1, 1);
INSERT INTO "public"."locations" VALUES (1, 0, 1, 2, 1);
INSERT INTO "public"."locations" VALUES (2, 0, 1, 3, 1);
INSERT INTO "public"."locations" VALUES (3, 0, 1, 1, 2);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."sections" VALUES (1, 'greate section 1');
INSERT INTO "public"."sections" VALUES (2, 'greate section 2');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."series" VALUES (0, 'the path to victory');
INSERT INTO "public"."series" VALUES (1, 'art');
INSERT INTO "public"."series" VALUES (2, 'flora');
INSERT INTO "public"."series" VALUES (3, 'briges');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."sizes" VALUES (0, 'small');
INSERT INTO "public"."sizes" VALUES (1, 'medium');
INSERT INTO "public"."sizes" VALUES (2, 'large');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."stamps" VALUES (0, 0, 1995, 1, 1, 100, 0, 'Lastochka', 1);
INSERT INTO "public"."stamps" VALUES (0, 0, 2012, 2, 2, 200, 1, 'Sapsan', 2);
INSERT INTO "public"."stamps" VALUES (1, 0, 1966, 0, 2, 500, 2, 'DC-2', 3);
INSERT INTO "public"."stamps" VALUES (1, 0, 1988, 3, 0, 300, 3, 'DC-3', 4);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."themes" VALUES (0, 'trains');
INSERT INTO "public"."themes" VALUES (1, 'plains');
INSERT INTO "public"."themes" VALUES (2, 'space');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."volumes" VALUES (0, 'greate volume 1');
INSERT INTO "public"."volumes" VALUES (1, 'greate volume 2');
COMMIT;
